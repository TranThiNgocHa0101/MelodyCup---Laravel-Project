                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action=" {{ route('account.authenticate') }}" method="post">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn bsb-btn-xl gradient-btn py-3" type="submit">Log in now</button>
                                            </div>
                                        </div>
                                        <div class="col-12 text-end mt-4">
                                            <a href="{{ route('account.forgotPass') }}" class="link-secondary text-decoration-none">Forgot password?</a>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">

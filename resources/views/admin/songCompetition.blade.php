...
<div class="container mt-5">
    <h1>Manage Competition songs</h1>
        ...
        <tbody>
            @forelse ($songs as $song)
                <tr>
                    ...
                    <a href="{{ route('admin.editCompetition', $song->id) }}" class="btn btn-success">Edit</a>
                    <form action="{{ route('admin.destroyCompetition', $song->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="viewNotesModalLabel-{{ $song->id }}">Notes - {{ $song->name }}</h5>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('competition.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="song" name="song" rows="10" placeholder="Nhập nốt nhạc dạng ký tự" required></textarea>
                            </div>
